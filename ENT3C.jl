module ENT3C
using HDF5, DataFrames, LinearAlgebra, Plots, Statistics

export load_cooler, vN_entropy
...
function vN_entropy(M::Matrix{Float64},SUB_M_SIZE_FIX,CHRSPLIT,WN_MAX,WS,BIN_TABLE)
	...
	for rr in 1:WN
        ...
        BIN_TABLE_NEW = BIN_TABLE_NEW[2:size(BIN_TABLE_NEW,1)]
